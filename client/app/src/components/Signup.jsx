        ...
        <section className="card wow fadeInLeft">
          ...
          <form action="#" className="form" method="post" onSubmit={this.onSubmit}>
              <div className="form__wrapper wow fadeInDown" data-wow-delay="0.5s">
                  <input type="name" onChange={this.onChange} className="form__input validate" id="name" name="name" required={true}/>
                  <small className="form-text text-muted">(Enter only two names, one Surname and any other Name.)</small>
